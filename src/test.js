...
function onPageLoad(){
    client_id = '717cad3f2d7f43529fbacd9d746b63db';
    client_secret = '075e40d5a43a494f86291cad0e8501ca';
...
function callApi(method, url, body, callback){
    ...
    xhr.setRequestHeader('Authorization', 'Bearer ' + 'BQApw1gxLJZdDHIIWYfcQLubwqvETTXPoF5frKfjoD3wzAispzNzNucBC1nFriDrQP4v6rDfD5MEEhMddJuf9hK8K6qrNfTgMS9UPOiIs1k3Z--rWA19Isod5QUXWnkpY_qj0C_JekZk_oRF-ILLeANTdtDesxOkjuEXOaPihSc13HtKkj5gR4HrFaivKckUR3_jT7G1Nf1jUY_eYZ7t-qwFFg');
    xhr.send(body);
    xhr.onload = callback;
}
...
function play(){
    let deviceRealId = document.querySelector('.devicesTest').value;
    console.log(deviceRealId);
    ...
    callApi( "PUT", PLAY + "?device_id=" + deviceRealId, JSON.stringify(body), handleApiResponse );
}
